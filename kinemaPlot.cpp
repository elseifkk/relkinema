...
#include <klocale.h>
/****************************************************************************
** Form implementation generated from reading ui file './kinemaPlot.ui'
**
** Created: 日  8月 14 19:27:58 2011
**
...
static const unsigned char img0_kinemaPlot[] = { 
...
/*
 *  Constructs a kinemaPlot as a child of 'parent', with the
 *  name 'name' and widget flags set to 'f'.
 */
kinemaPlot::kinemaPlot( QWidget* parent, const char* name, WFlags fl )
    : QWidget( parent, name, fl )
{
    QImage img;
    img.loadFromData( img0_kinemaPlot, sizeof( img0_kinemaPlot ), "PNG" );
    image0 = img;
    if ( !name )
	setName( "kinemaPlot" );
 ...
 *  language.
 */
void kinemaPlot::languageChange()
{
    setCaption( tr2i18n( "Plot" ) );
}

#include "kinemaPlot.moc"
